...
author: 
  ...
  - name: Stefan Reimann
    affiliation: 3
    email: stefan@somewhere-else.dom
affiliation:
  - code: 1
    address: Charles' institution address, Australia
  - code: 2
    address: www.rossgayler.com
  - code: 3
    address: Stefan's institution address, Switzerland
abstract: >
  The abstract of the article.
  It can also be on *multiple* lines.
header-includes: >
  \usepackage{lipsum}
bibliography: ../analysis/VSA_operators.bibtex
output:
  bookdown::pdf_book:
...
LaTeX formats citations and references automatically using the bibliography records in your .bib file, which you can edit via the project menu. Use the cite command for an inline citation, like @schlegelComparisonVectorSymbolic2020, and the citep command for a citation in parentheses [@schlegelComparisonVectorSymbolic2020].
